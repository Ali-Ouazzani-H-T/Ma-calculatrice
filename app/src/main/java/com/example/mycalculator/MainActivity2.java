    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.Home:
                ...
                Intent intent3 = new Intent(MainActivity2.this,HomePage.class);
            ...
            case R.id.Graphique:
                ...
                Intent intent2 = new Intent(MainActivity2.this,graphique.class);
                startActivity(intent2);
                return true;
            case R.id.poids:
                Toast.makeText(this,"Convertisseur de poids",Toast.LENGTH_SHORT).show();
                Intent intent4 = new Intent(MainActivity2.this,Convertisseur_poids.class);
                startActivity(intent4);
                return true;
            case R.id.temperature:
                Toast.makeText(this,"Convertisseur de Temperature",Toast.LENGTH_SHORT).show();
                Intent intent5 = new Intent(MainActivity2.this,Temperature_convert.class);
