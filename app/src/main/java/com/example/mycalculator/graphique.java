    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.poids:
                ...
                Intent intent4 = new Intent(graphique.this,Convertisseur_poids.class);
                startActivity(intent4);
                return true;
            case R.id.temperature:
                Toast.makeText(this,"Convertisseur de Temperature",Toast.LENGTH_SHORT).show();
                Intent intent5 = new Intent(graphique.this,Temperature_convert.class);
